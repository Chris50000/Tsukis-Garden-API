...
RUN chmod -R 775 /var/www/storage/framework/cache
RUN chmod -R 775 /var/www/storage/framework/cache/data

RUN chgrp www-data storage/framework/cache
RUN chgrp www-data storage/framework/cache/data
